...
> **Sources & provenance:** This roadmap is an independent synthesis of a defined public source corpus. See [Sources & Provenance](docs/sources-and-provenance.md) for references, source snapshots, licenses, attribution boundaries, and source mapping.
...
![FDE system map showing field context, technical capability domains, delivery interfaces, deployed outcome, and feedback](src/img/fde-roadmap-overview.png)

## The FDE Roadmap

This is the canonical roadmap for the guide.

![FDE roadmap stages showing core capabilities, specialization, and proof in the field](src/img/fde-roadmap-stages.png)
...
![FDE capability topology showing technical domains, interface layer, field interface, and outcome context](src/img/fde-skill-pillars.png)
...
![Forward delivery pipeline showing discover, frame, prototype, integrate, deploy, observe, and a field-learning feedback channel](src/img/fde-delivery-loop.png)
...
![FDE learning roadmap showing the core path, optional specialization tracks, and field evidence](src/img/fde-learning-path.png)
...
![Qualitative comparison of FDE and neighboring technical roles](src/img/fde-role-comparison.png)
...
![FDE decision axes showing recurring tradeoffs without fixed scores or preferred positions](src/img/fde-core-tradeoffs.png)
...
| Visual | Purpose |
|---|---|
| [Roadmap stages](src/img/fde-roadmap-stages.png) | Canonical eight-stage roadmap: core → specialize → prove. |
| [System map](src/img/fde-roadmap-overview.png) | Shows how field context, technical domains, delivery, outcomes, and feedback connect. |
| [Capability topology](src/img/fde-skill-pillars.png) | Shows FDE leverage at interfaces between technical and field domains. |
| [Delivery pipeline](src/img/fde-delivery-loop.png) | Shows the discover → deploy path plus an explicit field-learning return channel. |
| [Learning roadmap](src/img/fde-learning-path.png) | Separates the core path, optional depth tracks, and proof through field evidence. |
...
The visual diagrams were created with OpenAI image generation under human direction, curation, and review. OpenAI is used as a visual-production tool, not as a conceptual source for the FDE claims represented here.
...
This roadmap is an independent synthesis of a defined public source corpus. Detailed references, source snapshots, licenses, attribution boundaries, and the source map live in [Sources & Provenance](docs/sources-and-provenance.md).

For citation guidance, see [`CITATION.md`](CITATION.md). Machine-readable source metadata is available in [`SOURCES.yml`](SOURCES.yml).

## License

Original project expression is licensed under **Creative Commons Attribution 4.0 International (CC BY 4.0)**. See [`LICENSE`](LICENSE).
...
Visual diagrams were created with OpenAI image generation under human direction, curation, and review.
